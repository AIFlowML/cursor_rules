...
// **cURL to run (Generic):**
// ```bash
// curl -X GET -H "Authorization: GET_YOUR_DATAI_API" "https://api-v1.mymerlin.io/api/merlin/public/balances/{userAddress}?chain={chain}"
// ```
...
// **Tested cURL Command:**
// ```bash
// curl -X GET -H "Authorization: GET_YOUR_DATAI_API" "https://api-v1.mymerlin.io/api/merlin/public/balances/0x3764D79db51726E900a1380055F469eB6e2a7fD3?chain=matic" | cat
// ```
...
// run_curl_test "GET_WALLET_BALANCES_BY_CHAIN_DATAI" "curl -X GET -H \"Authorization: GET_YOUR_DATAI_API\" \"https://api-v1.mymerlin.io/api/merlin/public/balances/0x3764D79db51726E900a1380055F469eB6e2a7fD3?chain=matic\" | cat"
