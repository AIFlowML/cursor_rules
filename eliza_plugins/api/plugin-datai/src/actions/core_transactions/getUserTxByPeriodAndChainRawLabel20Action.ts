...
// *   `endTime`: `1705895733`
// *   API Key: `GET_YOUR_DATAI_API`

// **Tested cURL Command (User-provided working cURL):**
// ```bash
// curl --location "https://api-v1.mymerlin.io/api/merlin/public/v2/userTx/period/chain/rawlabel/20/0xbdfa4f4492dd7b7cf211209c4791af8d52bf5c50?chain=eth&startTime=1716346533&endTime=1705895733" --header "Authorization: GET_YOUR_DATAI_API" | cat
// ```
// **Notes from cURL testing:**
// *   This cURL command and parameters were provided by the user as a working example.
// *   The API key `GET_YOUR_DATAI_API` was used.
...
// *   Previous tests with the `GET_YOUR_DATAI_API` API key for this endpoint type sometimes returned empty arrays. This user-provided cURL is taken as the current correct working example.
...
// *   **API Key:** Pass the API key in the `Authorization` header (e.g., `Authorization: YOUR_API_KEY`). The user-provided working example uses `GET_YOUR_DATAI_API`.
// *   **Method:** `GET`
// *   **Path Parameters:**
...
// run_curl_test "GET_USER_TX_BY_PERIOD_AND_CHAIN_RAW_LABEL_20" "curl --location \"https://api-v1.mymerlin.io/api/merlin/public/v2/userTx/period/chain/rawlabel/20/0xbdfa4f4492dd7b7cf211209c4791af8d52bf5c50?chain=eth&startTime=1716346533&endTime=1705895733\" --header \"Authorization: GET_YOUR_DATAI_API\" | cat"
