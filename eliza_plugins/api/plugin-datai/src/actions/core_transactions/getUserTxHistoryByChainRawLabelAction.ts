...
// **cURL to run (Generic):**
// ```bash
// curl -X GET -H "Authorization: GET_YOUR_DATAI_API" "https://api-v1.mymerlin.io/api/merlin/public/v2/userTx/history/chain/rawlabel/{userAddress}?chain={chain}&limit={limit}"
// ```
...
// **Tested cURL Command:**
// ```bash
// curl -X GET -H "Authorization: GET_YOUR_DATAI_API" "https://api-v1.mymerlin.io/api/merlin/public/v2/userTx/history/chain/rawlabel/0x8e9741f27b21d6b3d5791b5566a880ecf5a1f21e?chain=eth&limit=10" | cat
// ```
...
// run_curl_test "GET_USER_TX_HISTORY_BY_CHAIN_RAW_LABEL" "curl -X GET -H \"Authorization: GET_YOUR_DATAI_API\" \"https://api-v1.mymerlin.io/api/merlin/public/v2/userTx/history/chain/rawlabel/0x8e9741f27b21d6b3d5791b5566a880ecf5a1f21e?chain=eth&limit=10\" | cat"
