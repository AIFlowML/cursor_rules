...
// *   Previous tests with the `GET_YOUR_DATAI_API` API key for this endpoint type sometimes returned empty arrays or had different timestamp conventions. This user-provided cURL is taken as the current correct working example.
...
// run_curl_test "GET_USER_TX_BY_PERIOD_AND_CHAIN_EXTENDED" "curl --location \"https://api-v1.mymerlin.io/api/merlin/public/v2/userTx/period/chain/extended/0xbdfa4f4492dd7b7cf211209c4791af8d52bf5c50?startTime=1716346533&endTime=1705895733&chain=xdai\" --header \"Authorization: GET_YOUR_DATAI_API\" | cat"
